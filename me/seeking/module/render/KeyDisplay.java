...
public class KeyDisplay extends Module {
    ...
    public void render2D(EventRender2D e){
        //Forward
        RenderUtils.drawShadow((float) (getX() + 20), (float) getY(), 20, 20);
        ...
        //Right
        RenderUtils.drawShadow((float) (getX() + 42), (float) (getY()+21), 20, 20);
        ...
        //Left
        RenderUtils.drawShadow((float) getX(), (float) getY()+21, 20, 20);
        ...
        //Back
        RenderUtils.drawShadow((float) (getX() + 21), (float) getY()+21, 20, 20);
