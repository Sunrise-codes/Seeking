...
public class KeyDisplay extends Module {
    ...
    public void render2D(EventRender2D e){
        ...
        mc.fontRendererObj.drawStringWithShadow(Keyboard.getKeyName(mc.gameSettings.keyBindForward.getKeyCode()).toUpperCase(), (float) (getX() + 27), (float) (getY()+6), -1);
        //Right
        ...
        mc.fontRendererObj.drawStringWithShadow(Keyboard.getKeyName(mc.gameSettings.keyBindRight.getKeyCode()).toUpperCase(), (float) (getX() + 50), (float) (getY()+27), -1);
        //Left
        ...
        mc.fontRendererObj.drawStringWithShadow(Keyboard.getKeyName(mc.gameSettings.keyBindLeft.getKeyCode()).toUpperCase(), (float) (getX() + 8), (float) (getY()+27), -1);
        //Back
        ...
        mc.fontRendererObj.drawStringWithShadow(Keyboard.getKeyName(mc.gameSettings.keyBindBack.getKeyCode()).toUpperCase(), (float) (getX() + 29), (float) (getY()+27), -1);
    }
}
