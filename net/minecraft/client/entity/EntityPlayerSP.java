...
import me.seeking.event.events.EventChat;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        EventUpdate eventUpdate = new EventUpdate(Event.Type.PRE, rotationYaw, rotationPitch, onGround);
        eventUpdate.call();
        float oldYaw = rotationYaw;
        float oldPitch = rotationPitch;
        boolean oldGround = onGround;
        rotationYaw = eventUpdate.getYaw();
        rotationPitch = eventUpdate.getPitch();
        renderYawOffset = eventUpdate.getYaw();
        rotationYawHead = eventUpdate.getYaw();
        onGround = eventUpdate.isOnGround();
        if(eventUpdate.isCancelled()){
            new EventUpdate(Event.Type.POST, rotationYaw, rotationPitch, onGround).call();
            return;
        }
    ...
    {
        new EventChat(message).call();
        if(!Seeking.instance.commandManager.processCommand(message))
