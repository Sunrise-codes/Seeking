...
public class CFontRender extends CFont {
    ...
    public CFontRender(Font font, boolean antiAlias, boolean fractionalMetrics) {
    ...
    private void setupBoldItalicIDs() {
        this.texBold = this.setupTexture(this.getFont().deriveFont(1), this.antiAlias, this.fractionalMetrics,
                this.boldChars);
        this.texItalic = this.setupTexture(this.getFont().deriveFont(2), this.antiAlias, this.fractionalMetrics,
                this.italicChars);
    }
